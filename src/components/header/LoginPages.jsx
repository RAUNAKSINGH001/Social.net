        ...
        <form action="" className="flex flex-col items-center gap-3 pt-5">
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              className="  ml-0 focus:outline-none rounded-2xl bg-gray-50 dark:bg-black h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={id}
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              className="  focus:outline-none rounded-2xl dark:bg-black bg-gray-50 h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={contact}
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              className="  ml-4 focus:outline-none rounded-2xl bg-gray-50 dark:bg-black h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={email}
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              className="  focus:outline-none rounded-2xl bg-gray-50 dark:bg-black h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={address}
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              id="age"
              placeholder="23"
              className=" ml-7 focus:outline-none rounded-2xl bg-gray-50 dark:bg-black h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={age}
          ...
          <div className=" rounded-2xl flex items-center  justify-self-start gap-4 py-1 px-4 ">
            ...
            <input
              ...
              className="  ml-8 focus:outline-none rounded-2xl bg-gray-50 dark:bg-black h-[6vh] w-[30vw] border-1 border-gray-400 px-4"
              value={bio}
          ...
          <button
            className="px-4 py-3 dark:bg-black border-2 hover:bg-gray-800 hover:text-gray-50 border-gray-400 active:scale-90 text:black dark:text-white rounded-2xl w-[6vw]"
            onClick={addToApi}
          >
            Register
          </button>
