    ...
    <div className='bg-slate-300 w-full min-h-[screen]  mb-5'>
      <div className='bg-gray-100 w-full justify-self-start gap-20 h-[10vh] rounded-2xl px-15 flex items-center'>
        ...
        <div className='border-1 border-gray-600 bg-gray-200  rounded-2xl flex items-center justify-center gap-2 py-1 px-4 '>
          ...
          <input type="text" placeholder="Search..."  className='  focus:outline-none rounded-2xl w-[20vw] border-1 border-gray-200 px-4' />
        </div>
        ...
        <div className='flex items-center justify-between w-full'>
            {
              tab.map((tab)=>
              (
                <NavLink  to={tab.path} className={({isActive})=>isActive?"h-[7vh] bg-gray-200 rounded-2xl px-3 py-1 flex flex-col items-center":" py-0.5 px-2 flex flex-col items-center h-[7vh]"}>
                  {tab.icon}
                  <h1>{tab.val}</h1>
                </NavLink>
